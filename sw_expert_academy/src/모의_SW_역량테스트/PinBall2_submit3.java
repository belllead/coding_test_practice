...
public class PinBall2_submit3 {
	static int score, currentR, currentC, N;
//	static int[] currentDirection;
	static int currentDirectionR, currentDirectionC;
//	static int[][] ballDirection = {{-1, 0}, {1, 0}, {0, -1}, {0, 1}};
	static int[] ballDirectionR = {-1, 1, 0, 0};
	static int[] ballDirectionC = {0, 0, -1, 1};
...
//			currentDirection = ballDirection[startDirection];
			currentDirectionR = ballDirectionR[startDirection];
			currentDirectionC = ballDirectionC[startDirection];
			
			while (board[currentR][currentC] != -1) {
				currentR += currentDirectionR;
				currentC += currentDirectionC;
	...
	private static void block(int i) {
		switch (i) {
		case 1:
			if (currentDirectionR == ballDirectionR[0]) { 
				currentDirectionR = ballDirectionR[1];
				currentDirectionC = ballDirectionC[1];
			} else if (currentDirectionR == ballDirectionR[1]) { 
				currentDirectionR = ballDirectionR[3];
				currentDirectionC = ballDirectionC[3];
			} else if (currentDirectionR == ballDirectionR[2]) { 
				currentDirectionR = ballDirectionR[0];
				currentDirectionC = ballDirectionC[0];
			} else if (currentDirectionR == ballDirectionR[3]) { 
				currentDirectionR = ballDirectionR[2];
				currentDirectionC = ballDirectionC[2];
			}
			score++;
			break;
		case 2:
